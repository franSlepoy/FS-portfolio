  ...
  return (
    ...
    <Box mt={28} sx={{ display: { xs: 'block', sm: 'flex' } }} > 
     ...
     <Carousel sx={carouselStyle}
      ...
      <Typography width={"90%"} m={1} variant="subtitle1" > Web de práctica que consume datos de una API publica con datos de todos los personajes de Rick and Morty. Realizada con React Js. y sus librerias Material UI y React router dom </Typography> 
      </Box>
